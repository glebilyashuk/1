...
namespace WBCR\Factory_Adverts_125;
...
class Base {
	 ...
	 * @author Alexander Kovalev <alex.kovalevv@gmail.com>
	 * @since  1.0.1
	 * @var \WBCR\Factory_Adverts_125\Creative_Motion_API
	 */
	private $api;
	 ...
	 * @since 1.0.0 Added
	 *
	 * @param \Wbcr_Factory447_Plugin $plugin
	 */
	public function __construct( \Wbcr_Factory447_Plugin $plugin, $settings ) {
		$this->plugin = $plugin;
	...
	public function register_dashboard_widget() {
		if ( $this->settings['dashboard_widget'] && current_user_can( 'manage_options' ) ) {
			...
			require_once FACTORY_ADVERTS_125_DIR . '/includes/class-dashboard-widget.php';
